          ...
          {(firstAuthor || publishedAt) && (
            <div className="flex gap-2">
              {firstAuthor && typeof firstAuthor === 'object' && (
                <>
                  <div className="flex">
                    <div className="relative inline-flex shrink-0 items-center justify-center rounded-full bg-avatar-bg size-10 outline-1 -outline-offset-1 outline-avatar-contrast-border">
                  ...
                  <div>
                    <div className="block rounded-xs text-sm font-semibold text-primary">
